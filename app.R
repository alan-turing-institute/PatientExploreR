  ...
  navbarPage(
            ...
            fluidRow(
              column(
                ...
                actionButton(
                  "gotoHelp",
                  "",
                  icon = icon("question-circle", "fa-5x"),
                  lib = "font-awesome"
                ),
                   ...
                   shinyjs::hidden(
                     div(
                       ...
                       fluidRow(shinyjs::hidden(div(
                         id = "intro_help_panel", uiOutput("intro_help")
                       ))),
                       fluidRow(
                         # utilities row
                         fluidRow(
                           column(
                             ...
                             fluidRow(
                               actionButton(
                                 "gotoFinder",
                                 "",
                                 icon = icon("search", "fa-3x"),
                                 lib = "font-awesome"
                               )
                             ),
                             fluidRow(tags$h5("Patient Finder"))
                           ),
                           column(
                             width = 10,
                             align = "left",
                         ...
                         fluidRow(
                           column(
                             ...
                             fluidRow(tags$h5("Overall Report"))
                           ),
                           column(
                             width = 10,
                             align = "left",
                           ...
                           column(
                             ...
                             fluidRow(
                               actionButton(
                                 "gotoInteractive",
                                 "",
                                 icon = icon("mouse-pointer", "fa-3x"),
                                 lib = "font-awesome"
                               )
                             ),
                             fluidRow(tags$h5("Encounter Timeline"))
                           ),
                           column(
                             width = 10,
                             align = "left",
                           ...
                           column(
                             ...
                             fluidRow(
                               actionButton(
                                 "gotoExplorer",
                                 "",
                                 icon = icon("wrench", "fa-3x"),
                                 lib = "font-awesome"
                               )
                             ),
                             fluidRow(tags$h5("Data Explorer"))
                           ),
                           column(
                             width = 10,
                             align = "left",
    ...
    tabPanel("Patient Finder",
             ...
             mainPanel(
               ...
               shinyjs::hidden(
                 div(
                   id = "finder_open",
                   fluidRow(align = "center", tags$h4("Patient Finder"), hr(width =
                                                                              100)),
                   fluidRow(
                     column(
                       width = 5,
                     ...
                     column(width = 4,
                            shinyjs::hidden (
                              # initialized as hidden, but show b/c of server function
                              div(id = "pt_search_open",
                                  fluidRow(
                                    textInput(
                                      inputId = "pt_search_bar_finder",
                                      label = "",
                                      placeholder = "Enter Patient ID..."
                                    )
                                  ),
                                  fluidRow(disabled(
                                    actionButton(inputId = "pt_search_button_finder",
                                                 label = "Search")
                                  )))
                            ))
                   ...
                   shinyjs::hidden (div(id = "criteria_search_text_open",
                                        fluidRow(
                                          uiOutput("selected_criteria_options")
                                        ))),
                   # end shinyjs:hidden  # selected criteria_text
                   shinyjs::hidden (div(id = "pts_found_open",
                                        fluidRow(
    ...
    tabPanel("Overall Report",
             ...
             mainPanel(
               ...
               shinyjs::hidden(
                 div(
                   id = "report_open",
                   fluidRow(align = "center", uiOutput("overall_title"), hr(width =
                                                                              100)),
                   fluidRow(uiOutput("report_pt_info"),
                            hr()),
                   #end fluidRow
                   fluidRow(uiOutput("report_pt_filter"),
                            hr()),
                   #end fluidRow
                   fluidRow(DT::dataTableOutput("report_table")) #end fluidRow
                 )
               )
             )),
      ...
      mainPanel(
        ...
        shinyjs::hidden(
          div(
            ...
            fluidRow(align = "center", uiOutput("timeline_title"), hr(width =
                                                                        100))
            ,
            fluidRow(uiOutput("timeline_filter_options"))
            ,
            shinyjs::hidden(
    ...
    tabPanel(
      ...
      mainPanel(shinyjs::hidden(
        div(
          id = "explorer_open",
          fluidRow(align = "center", uiOutput("explorer_title"), hr(width =
                                                                      100)),
          fluidRow(column(
            width = 3,
    ...
    navbarMenu(
      ...
      tabPanel(
        ...
        mainPanel(
          ...
          fluidRow(
            tags$h5("Step-by-step instructions for all pages by section below.")
          ),
          fluidRow(
            tags$p(
              "For further help, please contact Ben Glicksberg at benjamin.glicksberg@ucsf.edu"
            )
          ),
          tags$br(),
          tabsetPanel(
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      ...
                      tags$li(
                        "Learn more about our group and the application, data sources, and data format"
                      ),
                      tags$li(
                        "Instructions for how to download, install, and configure app for your EHR data"
                      ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      ...
                      tags$li(
                        "Username field (not required if not necessary to connect to database)"
                      ),
                      tags$li(
                        "Password field (not required if not necessary to connect to database)"
                      ),
                      tags$li(
                        "Host field (required): For MySQL this is typically a server address, but in other formats (e.g., PostgreSQL), this can be 'server/database'"
                      ),
                      tags$li(
                        "Database field (required): For MySQL this is the database itself. For PostgreSQL this is the schema."
                      ),
                      tags$li(
                        "Driver type (required): Relational database structure in which EHR data are stored (see below for more details)"
                      ),
                      tags$li("Port for connection (not required)"),
                      tags$li(
                        "Saves current credentials that are entered into the credentials .Renviron file (see Configuration page for more details) in the specified path (see #11). Note this button is disabled for the public sandbox webserver."
                      ),
                      tags$li(
                        "Loads credentials into respective field from credentials .Renviron file (see Configuration page for more details). Will only load fields that adhere to these formatting guidelines. This button will only be enabled if an .Renviron file can be found in the current specified path (see #11)."
                      ),
                      tags$li(
                        HTML(
                          "Set directory for credentials: Uses <a href= 'https://github.com/wleepang/shiny-directory-input'>DirectoryInput package </a> for selecting directory with credentials file. Credentials are saved in an .Renviron file (see Configuration page for more details). Note this button is disabled for the public sandbox webserver."
                        )
                      ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      ...
                      tags$li(
                        "Click to begin login process. This will check if connection to OMOP server can be made and if the OMOP tables exist. The app will not continue if required tables are missing. A warning message will be appear if tables are empty (but the app will still be able to run). Once these criteria are met, the app will load the data ontology (and save it if it doesn't exist in the specified direcotry) as well as patient demographic information."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      ...
                      tags$li(
                        "Patient Finder can be used for cohort querying and basic plots and information. Select a certain patient for other sections"
                      ),
                      tags$li(
                        "Requires a patient selected from #2. Interactive report of all clinical data generated as well as an automated clinical summary."
                      ),
                      tags$li(
                        "Requires a patient selected from #2. Intearactive timeline plot of clinical encounters as well as frequency plots."
                      ),
                      tags$li(
                        "Requires a patient selected from #2. The ability to explore finegrain details about patient clinical variables over time."
                      )
                    )
                  )
                )
              ...
              fluidPage(
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Search for patients either directly or by clinical criteria (mix-and-match of any type; details below). Searching for a patient will load all relevant clinical and encounter data for subsequent sections."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Sample generated patient for use in this example (see About section for more details)."
                      ),
                      tags$li(
                        "Search for patient: direct search will first check if patient exists and load all data if so."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Can search by all concepts contained in the CDM. Can first filter by Domain."
                      ),
                      ...
                      tags$li(
                        "Concepts can be selected by clicking the items in the table. This shows all concepts available based on the criteria above."
                      ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Vocabularies (and Concept Classes) are filtered by the previous selection. In this case, ICD10CM, ICD9CM, and SNOMED concepts can be selected as available from the Condition domain."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Specific codes/concepts can be searched for (e.g., ICD10CM: K51) which filters the concept table by relevant fields"
                      ),
                      tags$li(
                        "The Select All button will automatically select all concepts (in this case n=64) that are filtered based on criteria"
                      ),
                      tags$li("The None button unselects all concepts within the filtered list"),
                      tags$li(
                        "The criteria filtering limits the concept space by domain (can add different types)"
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "List of all criteria selected from above. Multiple types can be included here "
                      ),
                      tags$li(
                        "Table of all selected critera by term and vocabulary. Use Next and Previous to browse"
                      ),
                      tags$li(
                        "Select an item from the Selected Criteria table and click this button to remove item from selected list."
                      ),
                      tags$li("Reset Search will remove all selected criteria"),
                      tags$li(
                        "Search Type: 'or' will identify a cohort that meet EITHER of ay of the selected criteria; 'and' will require all conditions (i.e., concepts) met."
                      ),
                      tags$li(
                        HTML(
                          "Search Strategy: Direct will search for the concept directly terms directly (using the _source columns); Mapped (recommended) will first map terms to common ontology (e.g., SNOMED) and find/include all descendent concepts in search  (see <a href = 'https://github.com/BenGlicksberg/ROMOP'> ROMOP package </a> for more detials)."
                        )
                      ),
                      tags$li(
                        "Click to begin searching for cohort based on selection criteria/strategies"
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Table of all selected patients in cohort. Can filter cohort below by any demographic feature (automatically adjusts table and plots; see below for more details)"
                      ),
                      tags$li(
                        "Table can be sorted by clicking on columns and can show different amounts of entries per page. "
                      ),
                      tags$li(
                        "Table can be filtered by any demographic filter options by selecting subsets below column name."
                      ),
                      tags$li("Lists number of patients in filtered cohort"),
                      tags$li("Navigate the cohort table by these control buttons"),
                      tags$li(
                        "Can export/save cohort demographic table into a .csv file for utility in other programs."
                      ),
                      tags$li(
                        "Show plots of demographic features for cohort. Dynamically changed based on filter options"
                      ),
                      tags$li(
                        "Other sections of the app require a patient to be selected. Clicking on the seach button for patient in the row begins the search process."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li("Hide plots"),
                      tags$li(
                        "Dynamic and interactive (hoverable for tooltip text) plots of demographic features for selected cohort. Automatically altered based on filter options. Can be exported by hovering over the plot and clicking the plotly button for 'Download plot as png' "
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Filtering cohort subsets table below. In this example, 'Male' patients are selected only in addition to an age range."
                      ),
                      tags$li("The second row is our patient of interest"),
                      tags$li(
                        "Click on the Search button in the last column: retrieves all clinical and encounter data for selected patient for use in other sections"
                      )
                    )
                  )
                )
              ...
              fluidPage(
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Demographic background for selected patient (in this case patient id 9000000)"
                      ),
                      tags$li(
                        "Automatically generated clinical report for selected patient. Inlcudes information such as time in EHR, number of encounters (and by type), and clinical modalitiy entries (and by type)."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Table of all clinical concepts recorded for selected patient. Includes formatted data for all domains and organized by Date, Type (i.e., domain), Event (i.e., concept), and Value (if available; e.g. Measurement value)."
                      ),
                      tags$li("Browse entries in table"),
                      tags$li(
                        "Selet Data Modalities (i.e., domains) to include in report. Selections here will filter items from report table as well as filter options in #4 (i.e., will not display any items for domain if domain not selected)"
                      ),
                      tags$li(
                        "Filter specific concepts/items per modalitiy to include in report"
                      ),
                      tags$li(
                        "Can export all clinical data for given patient in .csv file for use in other programs or for further work"
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$br(),
                    tags$ol(tags$li(
                      "Select modalities (i.e., domains) to include in report"
                    ))
                  )
                ),
                tags$br(),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      ...
                      tags$li(
                        "Specific items in each modalitiy can be selected/unselected (in this case within Measurements)"
                      ),
                      tags$li(
                        "In addition to entire modalities, specific items unselected within each will not be included in the report"
                      ),
              ...
              fluidPage(
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "All encounter infomration for selected patient (in this case patient id 9000000). Clicking radiobuttonss under Plot Encounters will produce bar plots breakdown for selected type (e.g., Visit Types)"
                      ),
                      tags$li(
                        HTML(
                          "Select items from these fields will automatically generate and produce an interactive timeline visualization built using the <a href = 'https://github.com/daattali/timevis'>timevis package </a>. "
                        )
                      )
                    )
                  )
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "All options here are from what is available for the selected patient based on his/her encounter history. Selecting from these list will add all encounters of these types to the timeline."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Inveractive timeline visualization of encounters for selected patient. Can scroll left and right, zoom in and out, and select items by clicking on them. Encounter items are described by their Visit Type text"
                      ),
                      tags$li(
                        "All Visit Types (e.g., Inpatient Visit) selected in the dropdown are included in the visualization plot"
                      ),
                      tags$li(
                        "All Admitting Concept Types (e.g., Inpatient Hospital) selected in the dropdown are included in the visualization plot"
                      ),
                      tags$li(
                        "All Discharge Concept Types (e.g., Home) selected in the dropdown are included in the visualization plot"
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Buttons to automatically navigate timeline. Fit All Encounters will navigate the timeline to put all items on screen (note this can increase height of plot by a lot). Focus Past Year will focus the timeline to the previous year (e.g., 2017)."
                      ),
                      tags$li(
                        "All encounter items in the timeline can be selected. Here the third Outpatient Visit is selected for the current patient. Clicking on the timeline item populates information about the encounter below."
                      ),
                      tags$li(
                        "All information covered in the timeline for the encounter is displayed in the Encounter Information section"
                      ),
                      tags$li(
                        "All clinical data recorded during the encounter is contained within a table separated by tabs of each domain."
                      ),
                      tags$li(
                        "These tables contain pre-selected columns pertinent to the selected domain (e.g., 'Condition Status Type' for Condition) "
                      ),
                      tags$li(
                        "Clicking CSV or Excel buttons on each tab will allow for downloading the table in the affiliated format."
                      )
                    )
                  )
                )
              ...
              fluidPage(
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "The Targeted explorer option plots data based on clinical modality at a time (e.g. Conditions or Measurements). For all categorical data (Conditions, Devices, Medications, and Procedures), these are plotted as an interactive timeline. "
                      ),
                      tags$li(
                        "For the timeline there are two view types possible: Event will display each item as a single time point; Range will plot the item from start-to-end period if that information exists (note these are not always accurate) "
                      ),
                      tags$li(
                        "Users can select items of each modality from the dropdown to include in the plot. Only concepts recorded for the selected patient are available."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Timeline visualization automatically produced containing elements selected in the dropdown list in #2. As with other timelines, this is completely interactive."
                      ),
                      tags$li(
                        "Only items from the dropdown list are included in the timeline. These items are populated directly from patient-speicific concepts."
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "If Range option View Type is selected, the concept items in the timeline are displayed based on a range if available "
                      ),
                      tags$li(
                        "For items without an end date, they are still displayed as an Event (or single time point)"
                      ),
                      tags$li(
                        "Items with a range (e.g., Ulcerative Colitis) are displayed as a bar across the time period"
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Domains that contain numeric data, specifically Measurements and Observations (although the latter is a mix), are first displayed as a frequency table with the number of recorded events for each item."
                      ),
                      tags$li(
                        "Items in the frequency table can be selected by clicking to automatically produce a line plot"
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Select an item from the frequency table to view trends over time for that data concept ('C reactive protein [Mass/volume] in Serum or Plasma' selected in this case)"
                      ),
                      tags$li(
                        "An interactive line plot of all data points for the selected patients in the selected data concept is automatically produced"
                      ),
                      tags$li(
                        "High/Low values are automatically colored and coded based on the internal range system"
                      ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Multiplex mode: display multiple types of data on the same time scale plot"
                      ),
                      tags$li(
                        "Categorical data can be selected in which items are displayed as a dot plot"
                      ),
                      tags$li(
                        "Numerical data can be selected in which terms are displayed as a line plot"
                      )
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "Numeric data types (Measurements and Observations) can be selected based on what was measured for the selected patient"
                      ),
                      tags$li(
                        "Categorical data types (all others) can be selected in the same fashion"
                      )
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "The interactive multiplex plot is populated with selected items. Users can zoom in by clicking and dragging a section. All other items are then zoomed in at the same scale. Double clicking returns to original scale. Plots can be downloaded by hovering over the image and selecting 'Download plot as png'."
                      ),
                      tags$li(
                        "All items selected above are displayed in the legend. Categorical data are as dot plots on the top."
                      )
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "In the Multiplex Timeline Explorer mode, multiple types of data are displayed on the same time scale in a timevis plot."
                      ),
                      tags$li(
                        "All data types can be selected and included based on data available from the selected patient"
                      )
                    )
                  )
                ),
                ...
                fluidRow(
                  ...
                  column(
                    ...
                    tags$ol(
                      tags$li(
                        "All selected items for the selected patient are displayed in a timevis plot grouped by domain. This is interactive with the same options available as before"
                      ),
                      tags$li("Data can be viewed as an Event or Range as before"),
                      tags$li("All data items can be selected by clicking"),
                      tags$li(
                        "Information for the selected data item are displayed above the plot"
                      )
                    )
                  )
                )
      ...
      tabPanel(
        "About",
        fluidRow(align = "center", tags$h4("About"), hr(width =
                                                          100)),
        tags$br(),
      ...
      tabPanel(
        "Configuration",
        fluidRow(align = "center", tags$h4("Configuration"), hr(width =
                                                                  100)),
        tags$br(),
        style = "margin-left:250px; max-width:1000px; margin-right:250px",
        ...
        p(
          HTML(
            "<a href = 'https://github.com/BenGlicksberg/PatientExploreR'> GitHub Repository </a>"
          )
        ),
        tags$br(),
...
server <- function(input, output, session) {
  ...
  finder_term_table <-
    reactiveValues(df = data.table()) # terms per data ontology
  selected_finder_term_table <-
    reactiveValues(df = data.table(vocabulary = character(), term = character())) # selected terms based on vocabulary/term
  pts_search_found <-
    reactiveValues(
      pt_list = list(),
      genders = list(),
  ...
  enc_id_selected <-
    reactiveVal(as.character(NULL))
  pt_data_selected <- reactiveValues(l = list())
  pt_data_report <-
    reactiveValues(df = data.table())
  multiplex_timeline <-
    reactiveValues(df = data.table())
  ...
  sqlQuery <<- function(query) {
    ...
    translated_query <-
      SqlRender::translate(query, targetDialect = Sys.getenv("EXPLORER_DBMS"))

    # query using DatabaseConnector function
    result <-
      DatabaseConnector::querySql(con, translated_query)
  ...
  observeEvent(input$login, {
    ...
    ## load driver
    connection <- checkOMOPconnection()
    ...
    if (connection == TRUE) {
      ...
      if (length(missingTables) == 0) {
        # if no missing tables

        if (length(emptyTables) > 0) {
          # warning if any missing tables
          shinyalert(
        ...
        cs = sort(unique(dataOntology[domain_id == "Condition" &
                                        vocabulary_id == vs[1]]$concept_class_id))
        updatePickerInput(
          session,
          inputId = "finder_vocab_picker",
          choices = vs,
        ...
        finder_term_table$df = dataOntology[domain_id == "Condition" &
                                              vocabulary_id %in% vs[1], c(
                                                "concept_code",
                                                "concept_name",
                                                "domain_id",
                                                "vocabulary_id",
                                                "concept_class_id"
                                              )]  # initialize finder term table
        ...
        shinyalert(
          ...
          text = paste0(
            "The following REQUIRED tables are missing from the selected database ",
            dbname,
            ": \n",
  ...
  output$intro_help <- renderUI({
    fluidPage(
      ...
      "First time user? Check out the ",
      actionLink("gotoHelp2", "Help"),
      "page."
    )
  })
    ...
    withProgress(
      ...
      value = 0,
      {
        ...
        if (pt_found == TRUE) {
          ...
          multiplex_timeline$df <-
            format_multiplex_timeline(pt_data_report$df) # generate multiplex data from pt_report
  ...
  observeEvent(input$finder_domain_picker, {
    # update vocab by modality
    req(logged_in() == TRUE)
    ...
    finder_term_table$df = dataOntology[0, c(
      "concept_code",
      "concept_name",
      "domain_id",
      "vocabulary_id",
  ...
  observeEvent(input$finder_vocab_picker, {
    # update terms table by vocabulary
    req(logged_in() == TRUE)

    updatePickerInput(
      session,
      inputId = "finder_class_picker",
      choices = sort(unique(dataOntology[domain_id == input$finder_domain_picker &
                                           vocabulary_id %in% input$finder_vocab_picker]$concept_class_id)),
      selected = sort(unique(dataOntology[domain_id == input$finder_domain_picker &
                                            vocabulary_id %in% input$finder_vocab_picker]$concept_class_id))
    )

  })

  observeEvent(input$finder_class_picker, {
    # update terms table by vocabulary
    req(logged_in() == TRUE)

    dat = dataOntology[domain_id == input$finder_domain_picker &
                         vocabulary_id %in% input$finder_vocab_picker &
                         concept_class_id %in% input$finder_class_picker , c(
                           "concept_code",
                           "concept_name",
                           "domain_id",
                           "vocabulary_id",
  ...
  output$finder_term_picker <-
    DT::renderDataTable({
      req(
        !is.null(input$finder_domain_picker) &
          !is.null(input$finder_vocab_picker) &
          !is.null(input$finder_class_picker)
      )
  ...
  observeEvent(input$criteria_select_all_button_finder, {
    ...
    toaddstrings <-
      paste(
        finder_term_table$df[rows_sel,]$vocabulary_id,
        finder_term_table$df[rows_sel,]$concept_code,
        sep = ":"
      )
    newaddstrings <-
      setdiff(toaddstrings, vocab_term$l)
    if (length(newaddstrings > 0)) {
      vocabularies_split <- sapply(strsplit(newaddstrings, ":"), '[', 1)
      codes_split <-
        sapply(strsplit(newaddstrings, ":"), '[', 2)
  ...
  observeEvent(input$criteria_select_none_button_finder, {
    ...
    newremovestrings <-
      intersect(toremovestrings, vocab_term$l)
    if (length(newremovestrings > 0)) {
      vocabularies_split <-
        sapply(strsplit(newremovestrings, ":"), '[', 1)
      codes_split <-
        sapply(strsplit(newremovestrings, ":"), '[', 2)

      vocab_term$l = setdiff(vocab_term$l, newremovestrings)
      tmp_vf_tbl = data.table(vocabulary = vocabularies_split, term = codes_split)
      selected_finder_term_table$df = selected_finder_term_table$df[!tmp_vf_tbl, on =
                                                                      c("vocabulary", "term")]
    }
  ...
  sel <-
    reactive({
      !is.null(input$finder_term_picker_rows_selected)
    })
  ...
  observeEvent(input$finder_term_picker_cell_clicked, {
    if (length(input$finder_term_picker_cell_clicked) > 0) {
      ...
      if (!toaddstring %in% vocab_term$l) {
        ...
        tmp_vf_tbl = data.table(
          vocabulary = finder_term_table$df[input$finder_term_picker_cell_clicked$row,]$vocabulary_id,
          term = finder_term_table$df[input$finder_term_picker_cell_clicked$row,]$concept_code
        )
        selected_finder_term_table$df = rbind(selected_finder_term_table$df, tmp_vf_tbl)
  ...
  sel_selected <-
    reactive({
      !is.null(input$vocab_term_selected_table_rows_selected)
    })
  ...
  output$selected_criteria_options <- renderUI({
    search_button = actionButton(
      inputId = "criteria_search_button_finder",
      label = strong("Search by Criteria"),
      width = 200,
      height = 150
    )
    ...
    fluidPage(
      ...
      fluidRow(
        ...
        column(
          ...
          fluidRow(disabled(
            actionButton(
              inputId = "criteria_remove_button",
              label = "Remove Item",
              width = 150,
              height = 150
            )
          ...
          fluidRow(
            actionButton(
              inputId = "criteria_search_button_reset",
              label = "Reset Search",
              width = 150,
              height = 150
            )
  ...
  output$vocab_term_selected_table <-
    DT::renderDataTable({
  ...
  observeEvent(input$criteria_remove_button, {
    # remove term from selected table


    if (length(input$vocab_term_selected_table_cell_clicked) > 0) {
      toremovestring = paste(selected_finder_term_table$df[input$vocab_term_selected_table_cell_clicked$row, "vocabulary"],
                             selected_finder_term_table$df[input$vocab_term_selected_table_cell_clicked$row, "term"],
                             sep = ":")
  ...
  observeEvent(input$criteria_search_button_finder, {
    ...
    disable("show_plots")
    patient_list <-
      findPatients(selected_terms, func_type, search_strat)

    if (length(patient_list) > 0) {
      patient_list = as.character(unique(patient_list))
      pts_search_found$pt_list = patient_list
      pts_search_found$genders <-
        unique(pts_demographics[person_id %in% patient_list]$Gender)
      pts_search_found$races <-
        unique(pts_demographics[person_id %in% patient_list]$Race) #### <- single races here
      pts_search_found$statuses <-
        unique(pts_demographics[person_id %in% patient_list]$Status)
      pts_search_found$ethnicities <-
        unique(pts_demographics[person_id %in% patient_list]$Ethnicity)
      pts_search_found$ages <-
        c(min(pts_demographics[person_id %in% patient_list]$age),
          max(pts_demographics[person_id %in% patient_list]$age))
  ...
  observeEvent(input$criteria_search_button_reset, {
    ...
    selected_finder_term_table$df <-
      data.table(vocabulary = character(), term = character())
    global_cohort_found$df <-
      data.table(
        person_id = integer(),
        year_of_birth = integer(),
  ...
  output$pts_found_display <-
    renderUI({
      ### change renderUI to cohort_found ranges
      ...
      fluidPage(
        ...
        fluidRow(column(
          3,
          downloadButton(outputId = "save_cohort",
                         label = "Export Cohort")
        ),
        column(
          3,
        ...
        shinyjs::hidden(div(
          id = "finder_plots",
          fluidRow(plotlyOutput("cohort_plots") %>% withSpinner())
        )),
        fluidRow(DT::dataTableOutput("found_cohort_table"))
      )
    })
  ...
  output$cohort_plots <- renderPlotly({
    ...
    p0 <-
      plot_ly(cohort_found, x =  ~ age, type = 'histogram') %>% layout(
        xaxis = list(dtick = 10),
        showlegend = FALSE,
        annotations = ageTitle
      )
    ...
    genderData <-
      data.table(cohort_found %>%  dplyr::count(Gender) %>%  mutate(prop = prop.table(n)))
    ...
    raceData <-
      data.table(cohort_race %>%  dplyr::count(Race) %>%  mutate(prop = prop.table(n)))
    ...
    ethnicityData <-
      data.table(cohort_found %>%  dplyr::count(Ethnicity) %>%  mutate(prop = prop.table(n)))
    ...
    p3 <-
      ...
      layout(
        xaxis = list(title = "", tickangle = 90),
        showlegend = FALSE,
        annotations = ethnicityTitle
      )

    statusData <-
      data.table(cohort_found %>%  dplyr::count(Status) %>%  mutate(prop = prop.table(n)))
    ...
    subplot(
      ...
      nrows = 1,
      margin = 0.02,
      widths = c(0.3, 0.15, 0.3, 0.15, 0.1)
    ) %>% hide_legend() %>% layout(margin = list(b = 200, l = 20))
      ...
      cohort_found <-
        cohort_found %>% mutate(
          Search = shinyInput(
            ...
            onclick = 'Shiny.onInputChange(\"select_pt_button\",  this.id)'
          )
        )
  ...
  observeEvent(input$select_pt_button, {
    selectedRow <-
      as.numeric(strsplit(input$select_pt_button, "_")[[1]][2])
  ...
  output$save_cohort <- downloadHandler(
    ...
    content = function(file) {
      write.csv(global_cohort_found$df[input$found_cohort_table_rows_all],
                file,
                row.names = FALSE,
                quote = FALSE)
    }
  ...
  observeEvent(input$ReportPicker, {
    ...
    if (!"Observation" %in% input$ReportPicker) {
      shinyjs::disable("ReportObservationPicker")
    } else{
      shinyjs::enable("ReportObservationPicker")
    }
    if (!"Condition" %in% input$ReportPicker) {
      shinyjs::disable("ReportConditionPicker")
    } else{
      shinyjs::enable("ReportConditionPicker")
    }
    if (!"Procedure" %in% input$ReportPicker) {
      shinyjs::disable("ReportProcedurePicker")
    } else{
      shinyjs::enable("ReportProcedurePicker")
    }
    if (!"Medication" %in% input$ReportPicker) {
      shinyjs::disable("ReportMedicationPicker")
    } else{
      shinyjs::enable("ReportMedicationPicker")
    }
    if (!"Measurement" %in% input$ReportPicker) {
      shinyjs::disable("ReportMeasurementPicker")
    } else{
      shinyjs::enable("ReportMeasurementPicker")
    }
    if (!"Device" %in% input$ReportPicker) {
      shinyjs::disable("ReportDevicePicker")
    } else{
      shinyjs::enable("ReportDevicePicker")
    }
      ...
      column(
        ...
        fluidRow(
          ...
          pickerInput(
            ...
            selected = unique(pt_report$Type),
            # intialize all selected
            options = list(
              `actions-box` = TRUE,
              size = 25,
              `selected-text-format` = "count > 1"
        ...
        fluidRow(
          align = "center",
          #export button
          downloadButton(outputId = "export_report",
                         label = "Export Report")
        )
      ),
      column(
  ...
  output$report_table <-
    DT::renderDataTable({
      ...
      datatable(
        ...
        style = "bootstrap",
        options = list(columnDefs = list(list(
          targets = c(1, 2, 3), searchable = FALSE
        )),
        pageLength = 10)
      )
  ...
  output$export_report <- downloadHandler(
    ...
    content = function(file) {
      write.csv(filtered_pt_report()[input$report_table_rows_all],
                file,
                row.names = FALSE,
                quote = FALSE)
    }
  ...
  output$timeline_filter_options <-
    renderUI({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
  ...
  output$timeline_title <- renderText({
    ...
    if (!is.null(pt_id_selected())) {
      HTML(paste0(h4(
        "Encounters Timeline:  ", pt_id_selected()
      )))
    } else{
      HTML(paste0(h4("Select patient from Finder ", "")))
    }
  ...
  observeEvent(input$encounter_timeline_selected, {
    req(logged_in() == TRUE)
    tl_id <-
      input$encounter_timeline_selected
    ...
    output$encounter_conditions_table <-
      DT::renderDataTable({
        conditions <- pt_data_selected$l$Conditions

        conditions <-
          conditions[visit_occurrence_id == enc_id_selected()]

        conditions = conditions[, c(
          "condition_concept_name",
          "condition_type",
          "condition_status_type",
          "condition_concept_vocabulary",
    ...
    output$encounter_devices_table <-
      DT::renderDataTable({
        devices <- pt_data_selected$l$Devices

        devices <-
          devices[visit_occurrence_id == enc_id_selected()]
        ...
        devices = devices[, c(
          ...
          "device_concept_vocabulary",
          "device_concept_code",
          "device_source_vocabulary",
          "device_source_code"
        )]
    ...
    output$encounter_measurements_table <-
      DT::renderDataTable({
        req(logged_in() == TRUE & !is.null(pt_id_selected()))
        measurements <-
          pt_data_selected$l$Measurements

        measurements <-
          measurements[visit_occurrence_id == enc_id_selected()]
        ...
        measurements = measurements[, c(
          ...
          "measurement_type",
          "measurement_date",
          "measurement_concept_vocabulary",
    ...
    output$encounter_medications_table <-
      DT::renderDataTable({
        medications <- pt_data_selected$l$Medications

        medications <-
          medications[visit_occurrence_id == enc_id_selected()]

        medications = medications[, c(
          "medication_concept_name",
          "refills",
          "quantity",
          "days_supply",
          "drug_type",
    ...
    output$encounter_observations_table <-
      DT::renderDataTable({
        observations <- pt_data_selected$l$Observations

        observations <-
          observations[visit_occurrence_id == enc_id_selected()]
    ...
    output$encounter_procedures_table <-
      DT::renderDataTable({
        procedures <- pt_data_selected$l$Procedures

        procedures <-
          procedures[visit_occurrence_id == enc_id_selected()]

        procedures = procedures[, c(
          "procedure_concept_name",
          "procedure_type",
          "procedure_date",
          "procedure_concept_vocabulary",
          "procedure_concept_code",
          "procedure_source_vocabulary",
  ...
  output$pt_encounter_data_panel <-
    renderUI({
      # plot encounter/visit type information (UI for page)
      req(logged_in() == TRUE &
            !is.null(pt_id_selected()))
  ...
  output$encounter_info_text <- renderUI({
    ...
    req(logged_in() == TRUE &
          !is.null(pt_id_selected()) &
          !is.null(enc_id_selected()))

    encounters <-
      pt_data_selected$l$Encounters
    encounters <-
      encounters[visit_occurrence_id == enc_id_selected()]

    fluidPage(fluidRow(tags$h4("Encounter Information: ")),
              fluidRow(
                column(
                  5,
                  HTML(
                    paste0(
                      ...
                      encounters$visit_start_date
                    )
                  ),
                  tags$br(),
                  HTML(
                    paste0("<strong>Visit Type:</strong>  ", encounters$visit_concept)
                  ),
                  tags$br(),
                  HTML(
                    paste0(
                      "<strong>Visit Admitting Type:</strong>  ",
                      encounters$admitting_concept
                    )
                  ),
                  tags$br(),
                  HTML(
                    paste0(
                      "<strong>Visit Discharge Type:</strong>  ",
                      encounters$discharge_concept
                    )
                  )
                )
              ),
              tags$br()) #end FluidPage

  })


  output$plotly_pt_encounter_data <-
    renderPlotly({
      # encounters type bar plot
      encounters = pt_data_selected$l$Encounters
      if (input$encounter_plot_type != "no_enc_selected") {
        if (input$encounter_plot_type == "visit_types_selected") {
          encounters = encounters[, c("visit_occurrence_id",
                                      "visit_start_date",
                                      "visit_concept")]
  ...
  output$explorer_data <- renderUI({
    ...
    if (input$explorer_type == "explorer_targeted") {
      fluidPage(fluidRow(
        tabsetPanel(
          id = 'dataset_type_targeted_explorer',
          tabPanel(
            "Conditions",
            tags$br(),
      ...
      uiOutput("timevispanel")) # end fluidPage
      ...
      conditions <-
        pt_data_selected$l$Conditions
      conditions <-
        conditions[!is.na(condition_start_date),]

      medications <-
        pt_data_selected$l$Medications
      medications <-
        medications[!is.na(drug_exposure_start_date),]

      procedures <-
        pt_data_selected$l$Procedures
      procedures <-
        procedures[!is.na(procedure_date),]

      # filter numeric here removing NA dates & non-numeric results
      measurements <-
        pt_data_selected$l$Measurements
      measurements <-
        measurements[(!is.na(measurement_date) &
                        !is.na(as.numeric(value_as_number))),]

      devices <- pt_data_selected$l$Devices
      devices <-
        devices[!is.na(device_exposure_start_date),]

      observations <-
        pt_data_selected$l$Observations
      observations <-
        observations[(!is.na(observation_date)),]
      observations <-
        observations[!(is.na(value_as_number) &
                         is.na(value_as_string))]
      ...
      fluidPage(fluidRow(
        column(
          ...
          pickerInput(
            ...
            label = "Conditions",
            choices = sort(unique(
              conditions$condition_concept_name
            )),
            selected = c(""),
            options = list(
              `actions-box` = TRUE,
          ...
          pickerInput(
            ...
            label = "Medications",
            choices = sort(unique(
              medications$medication_concept_name
            )),
            selected = c(""),
            options = list(
              `actions-box` = TRUE,
        ...
        column(
          ...
          pickerInput(
            ...
            label = "Observations",
            choices = sort(unique(
              observations$observation_concept_name
            )),
            selected = c(""),
            options = list(
              `actions-box` = TRUE,
      ...
      fluidRow(uiOutput("multiplot_panel")))# end fluidPage
    } else if (input$explorer_type == "explorer_multiplex_timeline") {
      ## generate multiplex timeline data frame from report
      multiplex_timeline_data <-
        multiplex_timeline$df


      fluidPage(
        fluidRow(
          tags$h4("Select Variables to include in Timeline:", align = "center")
        ),
        fluidRow(
          column(
            width = 5,
            pickerInput(
              ...
              label = "Conditions",
              choices = sort(unique(multiplex_timeline_data[group ==
                                                              "Condition"]$content)),
              selected = c(""),
              options = list(
                `actions-box` = TRUE,
        ...
        fluidRow(timevisOutput("multiplex_timevis"))
  ...
  # procedures targeted
  output$procedures_explorer_targeted_panel <-
    renderUI({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
  ...
  output$targeted_timeline_explorer_procedures <-
    renderTimevis({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
  ...
  output$medications_explorer_targeted_panel <-
    renderUI({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
  ...
  output$meds_info_panel <- renderUI({
    req(
      logged_in() == TRUE &
        !is.null(pt_id_selected()) &
        !is.null(input$targeted_timeline_explorer_medications_selected)
    )
    ...
    fluidPage(
      fluidRow(
        ...
        tags$br(),
        tags$strong("Medication Standardized Concept Vocabulary: ", style =
                      "display:inline"),
        tags$p(
          medications_selected$medication_concept_vocabulary,
        ...
        tags$p(
          medications_selected$medication_source_vocabulary,
          style = "display:inline"
        ),
        tags$br(),
  ...
  output$targeted_timeline_explorer_medications <-
    renderTimevis({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
      ...
      if (input$meds_view_type == "meds_view_event") {
        # if Event selected | Range requires no change
        medications$end = NA
      }
  ...
  ### conditions targeted
  output$conditions_explorer_targeted_panel <-
    renderUI({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
      ...
      tagList(
        radioButtons(
          "conditions_view_type",
          "View Type:",
          choices =  c("Event" = "conditions_view_event",
                       "Range" = "conditions_view_range"),
          inline = TRUE
        ),
  ...
  conditions_targeted_explorer_data <-
    reactive({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
  ...
  output$targeted_timeline_explorer_conditions <-
    renderTimevis({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
      ...
      conditions = conditions[, c("condition_start_date",
                                  "condition_end_date",
                                  "condition_concept_name",
                                  "id")] # filter columns here
      ...
      if (input$conditions_view_type == "conditions_view_event") {
        # if Event selected | Range requires no change
        conditions$end = NA
      }
  ...
  output$conditions_info_panel <- renderUI({
    req(
      logged_in() == TRUE &
        !is.null(pt_id_selected()) &
        !is.null(input$targeted_timeline_explorer_conditions_selected)
    )
    ...
    fluidPage(
      ...
      tags$p(
        conditions_selected$condition_concept_vocabulary,
        style = "display:inline"
      ),
      tags$br(),
  ...
  ### devices targeted
  output$devices_explorer_targeted_panel <-
    renderUI({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
  ...
  devices_targeted_explorer_data <-
    reactive({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
  ...
  output$targeted_timeline_explorer_devices <-
    renderTimevis({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
      ...
      if (input$devices_view_type == "devices_view_event") {
        # if Event selected | Range requires no change
        devices$end = NA
      }
  ...
  output$devices_info_panel <- renderUI({
    req(
      logged_in() == TRUE &
        !is.null(pt_id_selected()) &
        !is.null(input$targeted_timeline_explorer_devices_selected)
    )
    ...
    if (input$dataset_type_targeted_explorer == "Measurements") {
      ...
      if (!is.null(i$value)) {
        ...
        p <-
          ...
          layout(
            xaxis = list(title = "Measurement Order Date"),
            yaxis = list(title = paste(
              i$value, unique(measurements2$unit_concept), sep = " "
            ))
          )
      ...
      if (!is.null(i$value)) {
        ...
        if (!is.na(unique(observations1$unit_source_value))) {
          yaxis_title = paste(i$value,
                              unique(observations1$unit_source_value),
                              sep = " ")
        } else{
          yaxis_title = i$value
        }
        ...
        if (nrow(observation_numeric) == nrow(observations1)) {
          # only numeric, include lines
          ...
          p <-
            ...
            layout(
              xaxis = list(title = "Observation Date"),
              yaxis = list(title = yaxis_title)
            )


        } else{
          # categorical, do not include lines
  ...
  get_measurement_explorer_row <-
    eventReactive(input$measurements_explorer_table_cell_clicked, {
  ...
  get_observation_explorer_row <-
    eventReactive(input$observations_explorer_table_cell_clicked, {
  ...
  output$measurements_explorer_table <-
    DT::renderDataTable({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
  ...
  output$observations_explorer_table <-
    DT::renderDataTable({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))
      ...
      if (nrow(observations) != 0) {
        ...
        observations = observations[!(is.na(observations$value_as_number) &
                                        is.na(observations$value_as_string)),]
  ...
  output$multiplot_panel <- renderUI({
    ...
    multiplex_selected <-
      c(
        input$conditions_explorer_multiplex,
        input$medications_explorer_multiplex,
        input$procedures_explorer_multiplex ,
        input$measurements_explorer_multiplex,
        input$devices_explorer_multiplex,
        input$observations_explorer_multiplex
      )
  ...
  output$multiplot <- renderPlotly({
    numeric_tbl_combined = data.table(
      "Date" = as.POSIXct(character(), format = "%Y-%m-%d"),
      "Name" = character(),
      "Value" = numeric()
    )

    categorical_tbl_combined = data.table(
      "StartDate" = as.POSIXct(character(), format = "%Y-%m-%d"),
      "EndDate" = as.POSIXct(character(), format = "%Y-%m-%d"),
      "Name" = character()
    )
    ...
    medications$StartDate = as.POSIXct(medications$drug_exposure_start_date, format =
                                         "%Y-%m-%d")
    medications$EndDate = as.POSIXct(medications$drug_exposure_end_date, format =
                                       "%Y-%m-%d")
    ...
    procedures$StartDate = as.POSIXct(procedures$procedure_date, format =
                                        "%Y-%m-%d")
    ...
    measurements <-
      measurements[(!is.na(measurement_date) &
                      !is.na(as.numeric(value_as_number))),]
    measurements$value_as_number = as.numeric(measurements$value_as_number)
    measurements$date = as.POSIXct(measurements$measurement_date, format =
                                     "%Y-%m-%d")
    ...
    observations$date = as.POSIXct(observations$observation_date, format =
                                     "%Y-%m-%d")
    ...
    if (nrow(numeric_tbl_combined) > 0 &
        nrow(categorical_tbl_combined) == 0) {
      ### numeric only
    ...
    } else if (nrow(numeric_tbl_combined) == 0 &
               nrow(categorical_tbl_combined) > 0) {
      # categorical only
      ...
      categorical_tbl_combined = categorical_tbl_combined[order(categorical_tbl_combined$id,
                                                                categorical_tbl_combined$StartDate),]

      p <-
        plot_ly(categorical_tbl_combined, colors = "Dark2") %>%
        add_markers(x = ~ StartDate,
                    y = ~ Name,
                    color = ~ Name) %>%
        add_segments(
          x = ~ StartDate,
      ...
      p2 <-
        plot_ly(categorical_tbl_combined, colors = "Spectral") %>%
        add_markers(x = ~ StartDate,
                    y = ~ Name,
                    color = ~ Name) %>%
        add_segments(
  ...
  output$multiplex_timeline_info_panel <-
    renderUI({
      req(logged_in() == TRUE & !is.null(pt_id_selected()))

      m_dat_id <-
        input$multiplex_timevis_selected

      if (is.null(m_dat_id)) {
        # if null present blank values
        m_dat_mode <- ""
        m_dat_concept <- ""
        m_dat_start <- ""
        m_dat_end <- ""
        ...
        m_dat_mode <-
          multiplex_data_selected$group
        m_dat_concept <-
          multiplex_data_selected$content
        m_dat_start <-
          multiplex_data_selected$start
        m_dat_end <-
          multiplex_data_selected$end
        m_dat_val <-
          multiplex_data_selected$Value
        m_to <- " to "
      }
  ...
  output$multiplex_timevis <- renderTimevis({
    ...
    multiplex_data = multiplex_data[!content %in% setdiff(
      unique(multiplex_data[group == "Condition",]$content),
      input$conditions_explorer_multiplex_timeline
    )] # do not include 'unselected' events
    multiplex_data = multiplex_data[!content %in% setdiff(
      unique(multiplex_data[group == "Observation",]$content),
      input$observations_explorer_multiplex_timeline
    )] # do not include 'unselected' events
    multiplex_data = multiplex_data[!content %in% setdiff(
      unique(multiplex_data[group == "Procedure",]$content),
      input$procedures_explorer_multiplex_timeline
    )] # do not include 'unselected' events
    multiplex_data = multiplex_data[!content %in% setdiff(
      unique(multiplex_data[group == "Measurement",]$content),
      input$measurements_explorer_multiplex_timeline
    )] # do not include 'unselected' events
    multiplex_data = multiplex_data[!content %in% setdiff(unique(multiplex_data[group == "Device",]$content),
                                                          input$devices_explorer_multiplex_timeline)] # do not include 'unselected' events
    multiplex_data = multiplex_data[!content %in% setdiff(
      unique(multiplex_data[group == "Medication",]$content),
      input$medications_explorer_multiplex_timeline
    )] # do not include 'unselected' events
    ...
    groups <-
      data.frame(unique(multiplex_data$group),
                 unique(multiplex_data$group))
    ...
    if (input$multiplex_view_type == "multiplex_view_type_event") {
      # if Event selected | Range requires no change
